...
public abstract class Runner implements Serializable, Runnable {
     ...
     *
     * @param HTMLdescription the description
     */
     ...
     *
     * @param pausePeriod the pausePeriod
     */
     ...
     *
     * @param periodName the periodName
     */
     ...
     *
     * @param restartingViews the restartingViews
     */
     ...
     * @throws SpatialTemporalException exception
     */
     ...
     *
     * @param autoRestart should the model restart when it ends?
     */
     ...
     *
     * @param applet the applet if are we in an applet vm context
     * @param args   paramter arguments for the scape
     * @param block  should this call block or run in a new thread?
     */
     ...
     *
     * @param modelName the fully qualified name of the Java class for the model's root scape
     * @param applet    the applet if are we in an applet vm context
     * @param args      paramter arguments for the scape
     * @param block     should this call block or run in a new thread?
     ...
     * Constructs, creates and runs the supplied model.
     *
     * @param modelName the fully qualified name of the Java class for the model's
     *                  root scape
     * @param args      paramter arguments for the scape
     * @param block     should this call block or run in a new thread?
     */
     ...
     * restarts.
     *
     * @param singlethread CURRENTLY IGNORED! should the run if restarted continue to use the same thread?
     */
