...
public class PanelView extends JPanel implements ComponentView, Externalizable {
    ...
    public void scapeAdded(ScapeEvent scapeEvent) throws TooManyListenersException {
        //We store scape here and in delegate for conveneince
    ...
    public void scapeRemoved(ScapeEvent scapeEvent) {
        ...
        //We actually need the scape value around so that we can still send control events back from control bar view
        //Arguably this vale (as "former" scape should persist anyway.
        //this.scape = null;
    }
    ...
    /* (non-Javadoc)
     * @see org.ascape.view.vis.ComponentView#onChangeIterationsPerRedraw()
     */
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        //System.out.println("writeExternal'ing PanelView/"+this+"...");
        ...
        //System.out.println("Done writeExternal'ing PanelView/"+this);
    }
    ...
    /* (non-Javadoc)
     * @see org.ascape.view.vis.ComponentView#forceScapeNotify()
     */
